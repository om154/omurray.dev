...
const EmailPill = ({ className }: EmailPillProps) => {
  ...
  return (
    <Link href={`mailto:${process.env.NEXT_PUBLIC_USER_EMAIL_ADDRESS}`} className={cn('inline-block px-3 py-2 font-bold bg-white rounded-lg shadow-md text-primary-900', className)}>
